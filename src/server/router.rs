...
pub fn crear_router(state: AppState) -> Router {
    ...
    Router::new()
        ...
        .route("/api/carteras", get(handlers::handler_listar_carteras))
        .route("/api/carteras/guardar", post(handlers::handler_guardar_cartera))
        .route("/api/carteras/:id", axum::routing::delete(handlers::handler_eliminar_cartera))
        .route("/api/reporte/html", get(handlers::handler_get_reporte_html))
        .route("/api/reporte-seguimiento/html", get(handlers::handler_get_reporte_seguimiento_html))
        ...
        .route("/api/4.png", get(handlers::handler_get_logo))
        .route("/api/reporte/4.png", get(handlers::handler_get_logo))
        .route("/api/reporte-seguimiento/4.png", get(handlers::handler_get_logo))
